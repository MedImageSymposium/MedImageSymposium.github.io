...
<div class="schedule-container">
   <div class="schedule-item">
        ...
        <div class="activity">Registration + Coffee + Setting up posters</div>
    </div>
    <div class="schedule-item">
        <div class="time">9:45 – 10:00</div>
        <div class="activity">Opening</div>
    </div>
    <div class="schedule-item">
        <div class="time">10:00 – 10:55</div>
        <div class="activity">Keynote I: <br> Willem Grootjans - "AI in Radiology: From Concept to Clinical Impact" </div>
    </div>
    <div class="schedule-item">
        <div class="time">11:00 – 12:00</div>
        <div class="activity">Oral presentations I</div>
    </div>
    <div class="schedule-item">
    ...
    <div class="schedule-item">
        <div class="time">13:00 – 13:55</div>
        <div class="activity">Keynote II: <br> Prerak Mody & Pieter Kitslaar - "AI data strategies in cardiac image processing"</div>
    </div>
    <div class="schedule-item">
        <div class="time">14:00 – 15:30</div>
        <div class="activity">Poster session + Coffee</div>
    </div>
    <div class="schedule-item">
        <div class="time">15:30 – 16:30</div>
        <div class="activity">Oral presentations II</div>
    </div>
    <div class="schedule-item">
        <div class="time">16:30 – 17:30</div>
        <div class="activity">Award ceremony + Informal drinks</div>
    </div>
</div>
<br>
...
### Keynote I: Willem Grootjans (LUMC)
